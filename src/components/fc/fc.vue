<template>
    <div style="height:100%">
        <Headers title="福彩3D"/>
        <p class="fc_tab">
            <span @click="tab(index)" v-for="(item,index) in tabs"
                  :class="item.status==1?'active':''">{{item.name}}</span>
        ...
        <div class="fc" v-if="tabs[0].status==1">
            ...
            <ul>
                <p>个位</p>
                <li @click="check(1,3,index)" v-for="(item,index) in ge" :class="item.active?'active':''">{{item.num}}
                </li>
            </ul>
        </div>
        <div class="fc" v-else-if="tabs[1].status==1">
            ...
            <ul>
                <p>选号</p>
                <li @click="check(2,0,index)" v-for="(item,index) in san" :class="item.active?'active':''">
                    {{item.num}}
                </li>
            </ul>
        </div>
        <div class="fc" v-else-if="tabs[2].status==1">
            ...
            <ul>
                <p>选号</p>
                <li @click="check(3,0,index)" v-for="(item,index) in liu" :class="item.active?'active':''">
                    {{item.num}}
                </li>
            </ul>
        </div>
    ...
    export default {
        data() {
            return {
                ...
                ge: [{num: 0, active: false}, {num: 1, active: false}, {num: 2, active: false}, {
                    num: 3,
                    active: false
                }, {num: 4, active: false},
                    {num: 5, active: false}, {num: 6, active: false}, {num: 7, active: false}, {
                        num: 8,
                        active: false
                    }, {num: 9, active: false}],
                shi: [{num: 0, active: false}, {num: 1, active: false}, {num: 2, active: false}, {
                    num: 3,
                    active: false
                }, {num: 4, active: false},
                    {num: 5, active: false}, {num: 6, active: false}, {num: 7, active: false}, {
                ...
                bai: [{num: 0, active: false}, {num: 1, active: false}, {num: 2, active: false}, {
                    num: 3,
                    active: false
                }, {num: 4, active: false},
                    {num: 5, active: false}, {num: 6, active: false}, {num: 7, active: false}, {
                ...
                san: [{num: 0, active: false}, {num: 1, active: false}, {num: 2, active: false}, {
                    num: 3,
                    active: false
                }, {num: 4, active: false},
                    {num: 5, active: false}, {num: 6, active: false}, {num: 7, active: false}, {
                ...
                liu: [{num: 0, active: false}, {num: 1, active: false}, {num: 2, active: false}, {
                    num: 3,
                    active: false
                }, {num: 4, active: false},
                    {num: 5, active: false}, {num: 6, active: false}, {num: 7, active: false}, {
        ...
        methods: {
            ...
            sure() {
                ...
                if (this.tabs[0].status == 1) {
                    this.$store.dispatch('selectFc', {
                        type: 1, zhu: this.acount, pric: this.total,
                        ge: this.gearr.map(v => {
                            return v.num
                        }), shi: this.shiarr.map(v => {
                            return v.num
                        }), bai: this.baiarr.map(v => {
                            return v.num
                        })
                    })
                    ...
                    this.$store.dispatch('selectFc', {
                        type: 2, zhu: this.acount, pric: this.total,
                        ge: this.sanarr.map(v => {
                            return v.num
                        })
                    })
                } else {
                    this.$store.dispatch('selectFc', {
                        type: 3, zhu: this.acount, pric: this.total,
                        ge: this.liuarr.map(v => {
                            return v.num
                        })
                    })
                }
